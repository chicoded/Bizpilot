...
const REPAIR_STATEMENTS = [
  ...
  EXCEPTION WHEN duplicate_object THEN NULL;
  END $$;`,
  // Hybrid inventory (restaurant menu / ingredients / packaging)
  `DO $$ BEGIN
  ...
  `CREATE INDEX IF NOT EXISTS "products_businessId_productType_idx" ON "products"("businessId", "productType");`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "recipe_lines_parentProductId_componentId_key" ON "recipe_lines"("parentProductId", "componentId");`,
  `CREATE INDEX IF NOT EXISTS "recipe_lines_componentId_idx" ON "recipe_lines"("componentId");`,
  `DO $$ BEGIN
