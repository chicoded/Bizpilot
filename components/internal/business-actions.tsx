        ...
        <div className="flex flex-wrap gap-2">
          {suspended ? (
            <button
              ...
              onClick={() => start(async () => { await activateBusiness(businessId); })}
            >
              Activate
            </button>
          ) : (
            <button
              ...
              onClick={() => start(async () => { await suspendBusiness(businessId); })}
            >
              Suspend
            </button>
          )}
          {canDelete && (
            <button
              ...
              onClick={() =>
                start(async () => {
                  if (!confirm("Permanently delete this business and all data?")) return;
